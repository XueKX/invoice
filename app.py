...
# 增值税发票OCR识别接口
@app.route('/invoice-ocr', methods=['GET', 'POST'])
def invoice_ocr():
    ...
    upload_path = "test"
    whole_path = os.path.join(basepath, upload_path, invoice_file_name)
    ...
    def remove_stamp(path, invoice_file_name):
        ...
        cv2.imwrite(basepath + '/test/RedThresh_{}.jpg'.format(invoice_file_name), RedThresh)
    ...
    def Recognition_invoice(path):
        ...
        img1 = basepath + '/test/RedThresh_{}.jpg'.format(invoice_file_name)
